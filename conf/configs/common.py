...
PROJECT_AUTH_HOST = config('PROJECT_AUTH_HOST', 'http://localhost:8000' if 'local' in ENVIRONMENT else f'https://auth.{ENVIRONMENT_PREFIX}heliumedu.com')
...
ALLOWED_HOSTS = [
    ...
    urlparse(PROJECT_AUTH_HOST).netloc.split(':')[0]
]

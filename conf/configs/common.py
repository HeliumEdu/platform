...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': (
        ...
        "setting them by hand; you still supply the meeting times, `anchor_date`, and `days_of_week`. "
        "Templates: `0` Weekly (no rotation), `1` A/B Day (`cycle_length` 2), `2` 6-Day Cycle "

...
class CourseSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = (
            ...
            'mon_start_time', 'tue_start_time', 'tue_end_time', 'wed_start_time', 'wed_end_time', 'thu_start_time',
            'thu_end_time', 'fri_start_time', 'fri_end_time', 'sat_start_time', 'sat_end_time', 'days_of_week_alt',
            'sun_start_time_alt', 'sun_end_time_alt', 'mon_start_time_alt', 'tue_start_time_alt', 'tue_end_time_alt',
            'wed_start_time_alt', 'wed_end_time_alt', 'thu_start_time_alt', 'thu_end_time_alt', 'fri_start_time_alt',

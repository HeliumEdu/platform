...
class CourseSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = (
            ...
            'teacher_name', 'teacher_email', 'start_date', 'end_date', 'sun_start_time', 'sun_end_time',
            ...
            'sun_start_time_alt', 'sun_end_time_alt', 'mon_start_time_alt', 'mon_end_time_alt', 'tue_start_time_alt',
            'tue_end_time_alt', 'wed_start_time_alt', 'wed_end_time_alt', 'thu_start_time_alt', 'thu_end_time_alt',
            'fri_start_time_alt', 'fri_end_time_alt', 'sat_start_time_alt', 'sat_end_time_alt', 'course_group')

    ...
    this.add_course_group_to_page = function (data) {
        if (helium.data_has_err_msg(data)) {
            ...
            if (data.shown_on_calendar) {
                ...
                details.append('<div class="infobox infobox-blue2">' + data.percent_thru.toFixed() + '<div class="infobox-progress"><div class="easy-pie-chart percentage easyPieChart" data-percent="' + (data.percent_thru < 100 ? data.percent_thru.toFixed() : 100) + '" data-size="46" style="width: 46px; height: 46px; line-height: 46px;"> <span class="percent">' + (data.percent_thru < 100 ? data.percent_thru.toFixed() : 100) + '</span>% <canvas width="46" height="46"></canvas></div></div><div class="infobox-data"><span class="infobox-text">thru term</span><div class="infobox-content">' + data.days_remaining + ' days remaining</div></div>');
                details.append('<div class="infobox infobox-red"><div class="infobox-icon"><i class="icon-beaker"></i></div><div class="infobox-data"><span class="infobox-data-number">' + data.num_items + '</span><div class="infobox-content">assignments</div></div></div>');
                details.append('<div class="infobox infobox-red"><div class="infobox-icon"><i class="icon-beaker"></i></div><div class="infobox-data"><span class="infobox-data-number">' + data.num_graded + '</span><div class="infobox-content">graded</div></div></div>');
                details.append('<div class="infobox infobox-blue2">' + data.percent_thru.toFixed() + '<div class="infobox-progress"><div class="easy-pie-chart percentage easyPieChart" data-percent="' + data.percent_thru.toFixed() + '" data-size="46" style="width: 46px; height: 46px; line-height: 46px;"><span class="percent">' + data.percent_thru.toFixed() + '</span>%<canvas width="46" height="46"></canvas></div></div><div class="infobox-data"><span class="infobox-text">' + data.num_complete + ' complete</span><div class="infobox-content">' + data.num_incomplete + ' remaining</div></div></div><div class="space-20"></div></div>');

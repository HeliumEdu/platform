    ...
    this.add_course_group_to_page = function (data) {
        if (helium.data_has_err_msg(data)) {
            ...
            if (data.shown_on_calendar) {
                ...
                details.append('<div class="infobox infobox-blue2">' + data.percent_thru.toFixed() + '<div class="infobox-progress"><div class="easy-pie-chart percentage easyPieChart" data-percent="' + data.percent_thru.toFixed() + '" data-size="46" style="width: 46px; height: 46px; line-height: 46px;"><span class="percent">' + data.percent_thru.toFixed() + '</span>%<canvas width="46" height="46"></canvas></div></div><div class="infobox-data"><span class="infobox-text">' + data.num_homework_completed + ' complete</span><div class="infobox-content">' + (data.num_homework - data.num_homework_completed) + ' remaining</div></div></div><div class="space-20"></div></div>');

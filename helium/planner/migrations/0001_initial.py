    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attachment', models.FileField(blank=True, help_text=b'The file to be uploaded.', null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight', models.DecimalField(decimal_places=2,
                                               help_text=b"A decimal weight for this category's homework (note that all weights associated with a single course cannot exceed a value of 100).",
                                               max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credits', models.DecimalField(decimal_places=2, help_text=b'A decimal corresponding to credit hours.',
                                                max_digits=4)),
                ('color', models.CharField(
                    choices=[(b'#ac725e', b'#ac725e'), (b'#d06b64', b'#d06b64'), (b'#f83a22', b'#f83a22'),
                             (b'#fa573c', b'#fa573c'), (b'#ff7537', b'#ff7537'), (b'#ffad46', b'#ffad46'),
                ...
                ('is_online', models.BooleanField(default=False,
                                                  help_text=b'Whether or not the course is online (and thus may have times associated with it)')),
                ...
                ('teacher_name',
                 models.CharField(blank=True, help_text=b'A display name for the teacher.', max_length=255)),
                ('teacher_email',
                 models.EmailField(blank=True, default=None, help_text=b'A valid email address.', max_length=254,
                                   null=True)),
                ...
                ('days_of_week_alt', models.CharField(default=b'0000000',
                                                      help_text=b'Seven booleans (0 or 1) indicating which days of the week the course is on (week starts on Sunday).',
                                                      max_length=7, validators=[
                        django.core.validators.RegexValidator(b'^[0-1]+$',
                                                              b'Seven booleans (0 or 1) indicating which days of the week the course is on (week starts on Sunday).',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_end_time', models.BooleanField(default=False,
                                                      help_text=b'Whether or not the end time should be shown on the calendar.')),
                ('start', models.DateTimeField(help_text=b'An ISO-8601 date.')),
                ('end', models.DateTimeField(help_text=b'An ISO-8601 date.')),
                ('priority',
                 models.PositiveIntegerField(default=50, help_text=b'A priority integer between 0 and 100.')),
                ('url', models.URLField(blank=True, help_text=b'An optional URL that the calendar item references.',
                                        max_length=3000, null=True)),
                ('comments',
                 models.TextField(blank=True, help_text=b'An arbitrary string (which may contain HTML formatting).')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events',
                                           to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('start',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category',
                 models.ForeignKey(blank=True, default=None, help_text=b'The category with which to associate.',
                                   null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='homework',
                                   to='planner.Category')),
                ('course', models.ForeignKey(help_text=b'The course with which to associate.',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveIntegerField(
                    choices=[(0, b'Owned'), (1, b'Rented'), (2, b'Ordered'), (3, b'Shipped'), (4, b'Need'),
                             (5, b'Received'), (6, b'To Sell')], default=0,
                    help_text=b'A valid material status choice.')),
                ('condition', models.PositiveIntegerField(
                    choices=[(0, b'Brand New'), (1, b'Refurbished'), (2, b'Used - Like New'), (3, b'Used - Very Good'),
                             (4, b'Used - Good'), (5, b'Used - Acceptable'), (6, b'Used - Poor'), (7, b'Broken')],
                    default=0, help_text=b'A valid material condition choice.')),
                ('website', models.URLField(blank=True, help_text=b'A valid URL.', max_length=3000, null=True)),
                ('price', models.CharField(blank=True, help_text=b'A price string.', max_length=255)),
                ('details',
                 models.TextField(blank=True, help_text=b'An arbitrary string (which may contain HTML formatting).')),
                ('courses', models.ManyToManyField(blank=True, default=None,
                                                   help_text=b'A list of courses with which to associate.',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shown_on_calendar',
                 models.BooleanField(default=True, help_text=b'Whether or not items should be shown on the calendar.')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='material_groups',
                                           to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('title',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.TextField(
                    help_text=b'A string that will be used as the reminder message (may contain HTML formatting).')),
                ('start_of_range', models.DateTimeField(help_text=b'An ISO-8601 date.')),
                ('offset', models.PositiveIntegerField(default=30,
                                                       help_text=b'The number of units (in `offset_type`) from the offset.')),
                ('offset_type',
                 models.PositiveIntegerField(choices=[(0, b'minutes'), (1, b'hours'), (2, b'days'), (3, b'weeks')],
                ...
                ('event', models.ForeignKey(blank=True, help_text=b'The event with which to associate.', null=True,
                                            ...
                                            to='planner.Event')),
                ('homework',
                 models.ForeignKey(blank=True, help_text=b'The homework with which to associate.', null=True,
                                   on_delete=django.db.models.deletion.CASCADE, related_name='reminders',
                                   to='planner.Homework')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reminders',
                                           to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('title',),
        ...
        migrations.AddField(
            model_name='material',
            name='material_group',
            field=models.ForeignKey(help_text=b'The material group with which to associate.',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, default=None,
                                         help_text=b'A list of materials with which to associate.',
                                         related_name='homework', to='planner.Material'),
        ),
        migrations.AddField(
            model_name='course',
            name='course_group',
            field=models.ForeignKey(help_text=b'The course group with which to associate.',
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(blank=True, help_text=b'The course with which to associate.', null=True,
        ...
        migrations.AddField(
            model_name='attachment',
            name='event',
            field=models.ForeignKey(blank=True, help_text=b'The event with which to associate.', null=True,
                                    on_delete=django.db.models.deletion.CASCADE, related_name='attachments',
                                    to='planner.Event'),
        ),
        migrations.AddField(
            model_name='attachment',
            name='homework',
            field=models.ForeignKey(blank=True, help_text=b'The homework with which to associate.', null=True,
                                    on_delete=django.db.models.deletion.CASCADE, related_name='attachments',
                                    to='planner.Homework'),
        ),
        migrations.AddField(

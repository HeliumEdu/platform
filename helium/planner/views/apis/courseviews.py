...
@extend_schema(
    tags=['planner.course', 'calendar.user']
)
...
class CourseGroupCoursesApiListView(HeliumAPIView, ListModelMixin, CreateModelMixin):
    ...
    def post(self, request, *args, **kwargs):
        ...
        logger.info(
            f"Course {response.data['id']} created in CourseGroup {kwargs['course_group']} for user {self.request.user.pk}")
...
class CourseGroupCoursesApiDetailView(HeliumAPIView, RetrieveModelMixin, UpdateModelMixin, DestroyModelMixin):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        logger.info(
            f"Course {kwargs['pk']} deleted from CourseGroup {kwargs['course_group']} for user {request.user.pk}")

...
class TestCaseInfoViews(APITestCase):
    def test_info(self):
        ...
        self.assertEqual(settings.MINIMUM_SUPPORTED_VERSION, response.data['minimum_supported_version'])
        ...
        self.assertEqual(['json', 'ics', 'zip'], response.data['import_file_types'])

...
from helium.feed.views.apis.externaleventviews import ExternalCalendarAsExternalEventsView
...
urlpatterns = [
    ...
    # TODO: need to implement enable/disable shortcuts for external calendar feeds

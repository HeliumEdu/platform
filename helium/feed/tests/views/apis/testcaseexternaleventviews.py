...
class TestCaseExternalCalendarViews(TestCase):
    ...
    def test_get_external_calendar_as_external_events(self, mock_urlopen):
        ...
        self.assertEqual(response.data[0]['start'], '2017-08-02T00:00:00Z')
        self.assertEqual(response.data[0]['end'], '2017-08-02T00:00:00Z')
        ...
        self.assertEqual(response.data[1]['start'], '2017-01-01T00:00:00Z')
        self.assertEqual(response.data[1]['end'], '2017-01-02T00:00:00Z')

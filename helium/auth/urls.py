...
from helium.auth.views.apis.oauthviews import GoogleLoginView, AppleLoginView
...
urlpatterns = [
    ...
    path('auth/apple/login/', AppleLoginView.as_view({'post': 'apple_login'}),
         name='auth_apple_login'),
